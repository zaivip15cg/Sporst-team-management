package com.example.sportsteammanagement.configuration;
...
public class ApplicationInitConfig {
    ...
    ApplicationRunner applicationRunner(com.example.sportsteammanagement.repository.UserRepository userRepository) {
        return args -> {
